...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([..._common_extend__WEBPACK_IMPORTED_MODULE_2__["default"], new (flarum_common_extenders__WEBPACK_IMPORTED_MODULE_1___default().Admin)() //
.setting(() => ({
  setting: 'fof-releases.username_mappings',
  label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('fof-releases.admin.settings.username_mappings_label'),
  help: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('fof-releases.admin.settings.username_mappings_help'),
  type: 'textarea',
  placeholder: '{\n  "github_username": "flarum_username",\n  "another_github": "another_flarum"\n}'
})).permission(() => ({
  icon: 'fas fa-rocket',
  label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('fof-releases.admin.permissions.publish_release_updates_label'),
...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('fof-extension-releases', () => {
  //
});
...
flarum_common_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('fof-extension-releases-common', () => {
  //
});
...
/******/ 		flarum.reg._webpack_runtimes["fof-extension-releases"] ||= __webpack_require__;// Check if module is in cache
